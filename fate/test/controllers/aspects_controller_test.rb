...
class AspectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aspect" do
    assert_difference('Aspect.count') do
      post aspects_url, params: { aspect: { character_id: @aspect.character_id, description: @aspect.description, name: @aspect.name } }, as: :json
    end
  ...
  test "should update aspect" do
    patch aspect_url(@aspect), params: { aspect: { character_id: @aspect.character_id, description: @aspect.description, name: @aspect.name } }, as: :json
    assert_response 200
  end
